  ...
  return (
    <div className="landing-page" style={{ background: "var(--gl-white)", color: "var(--ink)", fontFamily: "var(--font-body)", overflowX: "hidden" }}>
      ...
      <nav className={`landing-nav${navScrolled ? " scrolled" : ""}`}>
        <Link to="/" className="nav-logo">Social<span>Store</span></Link>
      ...
      <section className="hero" id="home">
        ...
        <div className="hero-content">
          <div className="hero-badge"><span /> World's #1 Social Accounts Marketplace</div>
          <h1>Verified <span>Premium</span> <span className="blue">Accounts</span> for Immediate Use</h1>
          <p style={{color: "white", opacity: '40%'}}>Instantly acquire established, verified social media accounts with organic reach and real followers. Secure, fast, and guaranteed.</p>

          <div style={{marginTop: '17px'}} className="hero-btns">
            <Link to="/auth" className="btn-primary"><span>Explore Inventory →</span></Link>
            <a href="#features" className="btn-ghost">How it Works</a>
          </div>
        </div>
        <div className="hero-stats">
          <div className="stat-card"><div className="stat-num">50K+</div><div className="stat-label">Transactions</div></div>
          <div className="stat-card"><div className="stat-num">24h</div><div className="stat-label">Support</div></div>
          <div className="stat-card"><div className="stat-num">100%</div><div className="stat-label">Secure</div></div>
        </div>
      </section>
      ...
      <section className="about landing-section" id="about">
        <div className="about-content reveal">
          ...
          <p className="section-sub">social-store is a premier provider of established social media accounts across all major platforms. We specialize in delivering authentic, ready-to-use accounts with real followers, genuine engagement, and verified status options.</p>
      ...
      <section className="why landing-section" id="why">
        <div className="why-header reveal">
          ...
          <h2 className="section-title">Why Choose <span style={{ color: "var(--blue)" }}>social-store?</span></h2>
        </div>
      ...
      <section className="testimonials landing-section" id="testimonials">
        <div className="testimonials-header reveal">
          ...
          <p className="section-sub">Join thousands of satisfied customers who trusted social-store to grow their social presence.</p>
        </div>
        <div className="testimonials-grid">
          {[
            ...
            { initials: "MC", name: "Michael Chen", role: "Digital Marketer", text: '"social-store made it incredibly easy to jumpstart my social media presence. The account had real engagement and authentic followers. Customer support was absolutely amazing!"', platform: "TikTok", platformIcon: "fa-brands fa-tiktok", stat: "250K Followers" },
            { initials: "ER", name: "Emily Rodriguez", role: "Business Owner", text: '"I was skeptical at first, but social-store exceeded all expectations. Instant delivery, secure payment, and the account metrics were 100% accurate. Highly recommend!"', platform: "YouTube", platformIcon: "fa-brands fa-youtube", stat: "180K Subscribers" },
      ...
      <section className="faq landing-section" id="faq">
        <div className="faq-inner">
          <div className="reveal">
            ...
            <p className="section-sub">Everything you need to know about buying social media accounts from social-store.</p>
          </div>
      ...
      <div className="cta-section">
        <h2 className="reveal">READY TO <em>ELEVATE</em><br />YOUR SOCIAL GAME?</h2>
        <p className="reveal reveal-delay-1">Join 10,000+ elite marketers and brands who trust us for their digital infrastructure. High-authority accounts are just a click away.</p>
        <div className="cta-btns reveal reveal-delay-2">
          <Link to="/auth" className="btn-dark">Browse Premium Catalog →</Link>
          <a href="#faq" className="btn-outline-dark">Questions? View FAQ</a>
        </div>
        <div className="cta-trust reveal reveal-delay-3">
          <span><i className="fa-solid fa-lock" /> SSL Encrypted</span>
          <span><i className="fa-solid fa-bolt" /> 30s Delivery</span>
          <span><i className="fa-solid fa-arrows-rotate" /> 48h Warranty</span>
        </div>
      </div>
      ...
      <footer className="landing-footer">
        <div className="footer-top">
          <div>
            <div className="footer-logo">Social <span>Store</span></div>
          ...
          <div className="footer-col">
            <h4>Contact</h4>
            <ul className="footer-links">
              <li><a href="#">support@social-store.org</a></li><li><a href="#">24/7 Support</a></li><li><a href="#">Live Chat</a></li><li><a href="#">Help Center</a></li>
            </ul>
          </div>
        </div>
        <div className="footer-bottom">
          <div className="footer-copy">© 2026 social-store. All rights reserved.</div>
